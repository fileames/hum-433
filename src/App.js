  ...
  return (
    <div className="App">
      ...
      <div class="text-center p-4" style={{ backgroundColor: "rgba(0, 0, 0, 0.05)" }}>
        ...
        <br/>
        Created by: Yasmin El Euch, <a class="text-reset fw-bold"  href="https://www.linkedin.com/in/elif-sema-balc%C4%B1o%C4%9Flu-70a712146/">Elif Sema Balcioglu</a>, Davide Romano, <a class="text-reset fw-bold"  href="https://www.linkedin.com/in/oliver-pineda-suarez/">Oliver Pineda Suarez</a>
        <br />
